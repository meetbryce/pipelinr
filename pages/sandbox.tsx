    ...
    <Layout>
      <div className="w-full px-6">
        <ul className={"flex md:space-x-3"}>
          <li>
            <NavLink href={"/"} exact={true} className="text-blue-500 hover:underline">
              Home
            </NavLink>
          </li>
          <li>
            <NavLink href={"/sandbox"} className="text-blue-500 hover:underline">
              Sandbox
            </NavLink>
          </li>
          <li>
            <NavLink href={"/pipelines"} className="text-blue-500 hover:underline">
              Pipelines
            </NavLink>
          </li>
          <li>
            <NavLink href={"/pipelines"} className={(isActive: boolean) => (isActive ? "ACTIVE" : "inactive")}>
              Pipelines
            </NavLink>
          </li>
          <li>
