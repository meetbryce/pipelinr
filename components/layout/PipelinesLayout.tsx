      ...
      <div className="w-full px-6">
        <nav className="flex px-6 py-4" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li>
              <div className="flex items-center">
                <ChevronRightIcon className="mr-1 h-5 w-5 flex-shrink-0 text-gray-400 md:mr-2" aria-hidden="true" />
                  ...
                  >
                    <Menu.Items className="absolute left-0 z-10 mt-2 w-56 origin-top-left divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
                        {pipelines.map(pipeline => (
                          ...
                          >
                            <Menu.Item as="div" className="flex w-full px-4 py-2 text-sm">
                              <PipelineIcon className="mt-0.5 mr-2 h-4 w-4" />
                              {pipeline.name}
                            </Menu.Item>
                          </NavLink>
                        ))}
                        ...
                        >
                          <Menu.Item as="div" className="flex w-full px-4 py-2 text-sm">
                            <PlusIcon className="mt-0.5 mr-2 h-4 w-4" />
                            New pipeline
                          </Menu.Item>
                        </NavLink>
                      </div>
